...
- **示例请求（JWT认证，推荐）**：
  ```bash
  curl -X POST "http://localhost:3003/api/optimize/start" \
    -H "X-Airline: F8" \
...
- **示例请求**：
  ```bash
  curl -X POST "http://localhost:3003/api/optimize/stop/task_123" \
    -H "X-Airline: F8" \
...
- **示例请求**：
  ```bash
  curl -X GET "http://localhost:3003/api/optimize/status/task_123" \
    -H "X-Airline: F8" \
    -H "Authorization: Bearer your_secret_token"
  ```
...
- **示例请求**：
  ```bash
  curl -X GET "http://localhost:3003/api/optimize/progress/task_123" \
    -H "X-Airline: F8" \
    -H "Authorization: Bearer your_secret_token"
  ```
...
- **示例请求**：
  ```bash
  curl -X GET "http://localhost:3003/api/system/info" \
    -H "X-Airline: F8" \
    -H "Authorization: Bearer your_secret_token"
  ```
...
- **示例请求**：
  ```bash
  curl -X GET "http://localhost:3003/api/optimizers" \
    -H "X-Airline: F8" \
    -H "Authorization: Bearer your_secret_token"
  ```
...
- **示例请求**：
  ```bash
  # 获取指定航司的运行中任务
  curl -X GET "http://localhost:3003/api/tasks/running" \
    -H "X-Airline: F8" \
    -H "Authorization: Bearer your_secret_token"
  ```
...
- **示例请求**：
  ```bash
  # 获取指定航司的所有任务
  curl -X GET "http://localhost:3003/api/tasks/all" \
    -H "X-Airline: F8" \
    -H "Authorization: Bearer your_secret_token"
  ```
...
response = requests.post(
    "http://localhost:3003/api/optimize/start",
    json={
        "airline": "F8",
        "url": "http://localhost",
        "user": "0001",
