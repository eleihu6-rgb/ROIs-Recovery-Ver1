...
- 时间：2026-09-14 11:07:48 PDT
- Wing：`gantt`
- Topic：`case4-review-fixes`
- Title：Case 4 search and display review fixes
- Git branch：`main`

## 本轮对话上下文

Completed user's three follow-up issues: wide-scope search starvation, long-layover chart labels, Case4 shell alignment with Cases1–3. See docs/test-cases/crew-recovery/2026-09-14-1106-case4-review-fixes-Ver1.md for exact commands/evidence/limitations.
Search now anchored at incident, backwards to base then forwards, with direct base connection priority and existing budget/validation. Legacy algorithms untouched. Header includes anchor date; actual Sep19 ET895 is 159575 fleet7M8, separate from prepared Sep17 159578 fleet738. No Sep19 writes.
Chart independent duty scales, external readable labels, explicit ground/rest gaps. Case4 AppDialog/rail/footer follows legacy presentation; footer Build submits child form and remains immediate save. Help/skill updated.
91 focused tests and 8 distinct UI tests PASS including exact Sep19 wide scope, long layover, Build/reopen, both-rank Standby Preview/Apply/Save, Help and Cases1–3 read-only. Existing 3 unrelated frontend tsc errors remain. UI gate and diff checks PASS.
Test target152688 and four assignments scoped-reset; earlier build-only152687 also reset. Final baseline verify PASS; protected hash a1ee222c67c0827bd3dee8419266367d86eaa52826df2648bc72439ec7239cf6 unchanged. Final read-only UI rerun PASS. Do not reset any user's newly created pairing. No commit/push. MemPalace missing in prior save; report indexing failure honestly.
...
1. `NEXT_CONTEXT.md`
2. 本文件：`docs/dev-context/2026-09-14-gantt-case4-review-fixes.md`
