...
class LiveServerClient:
    ...
    def _post(self, airline: str, url_path: str, *,
              ...
              error_prefix: str = "HTTP request failed") -> requests.Response:
    ...
    def get_input_data(self, airline: str, url_path: str,
        ...
        response = self._post(
            ...
            error_prefix="Failed to fetch input data",
        )
    ...
    def submit_output_data(self, airline: str, url_path: str,
        ...
        self._post(
            ...
            extra_headers=extra_headers,
            error_prefix="Failed to submit output data",
        )
        return True
    ...
    def submit_result_metadata(self, airline: str, url_path: str,
        ...
        self._post(
            ...
            content_type='application/json',
            extra_headers=extra_headers,
            error_prefix="Failed to submit result metadata",
        )
        return True
