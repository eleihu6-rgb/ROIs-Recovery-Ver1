...
export const HELP_CATEGORIES: HelpCategory[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { slug: 'recovery-case-002', title: 'Case study 2 — S2 published flight delay at ADD (Partial)', categorySlug: 'recovery', stepCount: 10, isNew: true, overview: 'ET Flight Delay for pairing 152675 ET2681/ET2682/ET2683/ET2684 at ADD: crew T2001/T2021/T2022, Rule 3007 published-delay alert, FDP Discretion request action before Preview with not sent / sent / accepted / rejected / resend status, crew app Yes/No communication, Standby Crew callout recommended after a rejection, Swap duty candidates and an empty Flight Delay group. Recovery execution remains partial.' },
      { slug: 'recovery-case-003', title: 'Case study 3 — 8004 crew-fleet mismatch at ADD (Partial)', categorySlug: 'recovery', stepCount: 10, isNew: true, overview: 'Rule 8004 crew fleet mismatch for ADD pairing 152227: flights changed 788 to 7M8, alert from Alert Center, Pairing pane and Roster pane, three recovery methods, Executable and Filtered candidates, cost breakdown, Preview, Apply to draft and Save. Fleet matching is mandatory — unqualified crew are not listed — and a 7M8-qualified replacement fully clears the 8004.' },
      { slug: 'recovery-case-004', title: 'Case study 4 — build and staff an open pairing', categorySlug: 'recovery', stepCount: 7, isNew: true, overview: 'Build a saved base-return pairing from an unpaired flight, reopen the open or partially staffed pairing directly to fill rank seats, compare Standby Crew, Available Crew and Move-up / Roster Transfer, review Cost breakdown, Preview, Apply to draft and Save. Donor vacancies remain Partial.' },
    ],
  },
  {
    slug: 'scenario',
