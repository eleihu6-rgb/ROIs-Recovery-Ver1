...
export const HELP_CATEGORIES: HelpCategory[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { slug: 'recovery-case-002', title: 'Case study 2 — S2 flight delay FDP agreement (Partial)', categorySlug: 'recovery', stepCount: 10, isNew: true, overview: 'S2 Flight Delay for PI201/PI202 HKG to SIN: prepared SIN B787 crew pool, FDP exceedance recovery approach, discretion agreement request, crew app Yes/No communication, six standby teams, six swap donor teams and distinct GH costs. Recovery execution remains partial.' },
      { slug: 'recovery-case-003', title: 'Case study 3 — 8004 crew-fleet mismatch at ADD (Partial)', categorySlug: 'recovery', stepCount: 10, isNew: true, overview: 'Rule 8004 crew fleet mismatch for ADD pairing 152227: flights changed 788 to 7M8, alert from Alert Center, Pairing pane and Roster pane, three recovery methods, Executable and Filtered candidates, cost breakdown, fleet mismatch warning, Preview, Apply to draft and Save. The 8004 remains for a 788-only replacement because fleet is a soft constraint.' },
    ],
  },
  {
    slug: 'scenario',
