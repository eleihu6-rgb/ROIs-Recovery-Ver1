...
export const DATA_ENTITY_REGISTRY: Record<DataEntityId, DataEntityConfig> = {
  ...
  crew_absence:         { ...stub('crew_absence', 'crew_absence', 'crew.master', 'Crew Absence'), columns: [{ key: 'id', dbField: 'id', label: 'ID', type: 'number', readonly: true }, { key: 'crewId', dbField: 'crew_id', label: 'Crew ID', type: 'text', readonly: true }, { key: 'absenceType', dbField: 'absence_type', label: 'Type', type: 'text', readonly: true }, { key: 'assignment', dbField: 'assignment', label: 'Code', type: 'text', readonly: true }, { key: 'fromDate', dbField: 'from_date', label: 'From', type: 'date', readonly: true }, { key: 'toDate', dbField: 'to_date', label: 'To', type: 'date', readonly: true }, { key: 'base', dbField: 'base', label: 'Base', type: 'text', readonly: true }, { key: 'status', dbField: 'status', label: 'Status', type: 'text', readonly: true }, { key: 'source', dbField: 'source', label: 'Source', type: 'text', readonly: true }, { key: 'removedPairingIds', dbField: 'removed_pairing_ids', label: 'Removed Pairings', type: 'text', readonly: true }, { key: 'note', dbField: 'note', label: 'Note', type: 'text', readonly: true }, { key: 'createdAt', dbField: 'created_at', label: 'Submitted', type: 'datetime', readonly: true }], businessKey: ['crewId', 'fromDate'] },
