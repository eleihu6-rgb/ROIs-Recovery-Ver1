...
#include <cstring>
#include <map>
#include "StringUtil.h" //for strToLower/ strToUpper
using namespace std;
...
string joinStrList(const std::map<string, int>& list, string delim, bool isKey = true);
...
string formatInt(int n);//1234567 -> '1,234,567'
string intToStr(int n);	//1234567 -> '1234567'
