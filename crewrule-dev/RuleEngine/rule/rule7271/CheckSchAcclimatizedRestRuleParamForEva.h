...
#ifndef _CHECKSCHACCLIMATIZEDRESTRULEPARAMFOREVA_H_
#define _CHECKSCHACCLIMATIZEDRESTRULEPARAMFOREVA_H_
...
class CheckSchAcclimatizedRestRuleForEva;

class CheckSchAcclimatizedRestRuleParamForEva : public RuleParam {
	friend class CheckSchAcclimatizedRestRuleForEva;
private:
	explicit CheckSchAcclimatizedRestRuleParamForEva(const Rule* rule) :RuleParam(rule) {};
...
#endif //_CHECKSCHACCLIMATIZEDRESTRULEPARAMFOREVA_H_
