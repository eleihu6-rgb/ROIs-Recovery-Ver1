/**
 * @file CrewOnlyPerformSpecificTaskForPRRuleParam.h
 * @brief
 * @author xuedong.he
...
void CrewOnlyPerformSpecificTaskForPRRuleParam::ParseParam(const std::string &paramString) {
...
void CrewOnlyPerformSpecificTaskForPRRuleParam::ParseParam(const DBRule& dbRule) {
...
//bool CrewOnlyPerformSpecificTaskForPRRuleParam::MatchCrewQualification(std::shared_ptr<CREW> crew, const time_t& checkedStartTime, const time_t& checkedEndTime) const {
...
bool CrewOnlyPerformSpecificTaskForPRRuleParam::MatchPairingAttributes(const ROSTER* roster) const {
...
bool CrewOnlyPerformSpecificTaskForPRRuleParam::MatchFlightAirportCategories(const Segment* segment) const {
...
bool CrewOnlyPerformSpecificTaskForPRRuleParam::MatchFlightRoutes(const Segment* segment) const {
...
bool CrewOnlyPerformSpecificTaskForPRRuleParam::MatchActingRankAndIsTraining(const ROSTER* roster, const Segment* segment) const {
...
bool CrewOnlyPerformSpecificTaskForPRRuleParam::MatchTrainingRoles(const ROSTER* roster, const Segment* segment) const {
...
bool CrewOnlyPerformSpecificTaskForPRRuleParam::MatchCrewNationalities(const std::shared_ptr<CREW>& crew) const {
...
bool CrewOnlyPerformSpecificTaskForPRRuleParam::MatchFlight(const ROSTER* roster, const Segment* segment) const {
	auto& dbData = this->GetRule()->GetDataContext();
...
bool CrewOnlyPerformSpecificTaskForPRRuleParam::MatchGroundRoster(const ROSTER* roster) const {
	auto& dbData = this->GetRule()->GetDataContext();
...
bool CrewOnlyPerformSpecificTaskForPRRuleParam::MatchCrew(const ROSTER* roster, const std::shared_ptr<CREW>& crew) const {
...
string CrewOnlyPerformSpecificTaskForPRRuleParam::GetCrewFilterConditionDesc() const {
	stringstream ss;
...
string CrewOnlyPerformSpecificTaskForPRRuleParam::GetTaskFilterConditionDesc() const {
	stringstream ss;
	...
	if (!_strPairingAttributes.empty() && _strPairingAttributes != RuleParamConstant::ALL) {
		ss << "/" << _strPairingAttributes;
	}
