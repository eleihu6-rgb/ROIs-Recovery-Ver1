...
#ifndef _CREWONLYPERFORMSPECIFICTASKFORPRRULEPARAM_H_
#define _CREWONLYPERFORMSPECIFICTASKFORPRRULEPARAM_H_
...
class CrewOnlyPerformSpecificTaskForPRRule;

class CrewOnlyPerformSpecificTaskForPRRuleParam : public RuleParam {
	friend class CrewOnlyPerformSpecificTaskForPRRule;
private:
    explicit CrewOnlyPerformSpecificTaskForPRRuleParam(const Rule* rule) :RuleParam(rule) {};
...
#endif //_CREWONLYPERFORMSPECIFICTASKFORPRRULEPARAM_H_
