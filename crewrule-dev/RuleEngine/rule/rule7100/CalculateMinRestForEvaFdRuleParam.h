...
#ifndef _CALCULATEMINRESTFOREVAFDRULEPARAM_H_
#define _CALCULATEMINRESTFOREVAFDRULEPARAM_H_
...
class CalculateMinRestForEvaFdRule;

class CalculateMinRestForEvaFdRuleParam : public RuleParam {
friend class CalculateMinRestForEvaFdRule;
private:
    explicit CalculateMinRestForEvaFdRuleParam(const Rule* rule):RuleParam(rule) {};
...
#endif //_CALCULATEMINRESTFOREVAFDRULEPARAM_H_
