...
void CalculateMinRestAfterCumulativeFTForEvaFdRuleParam::ParseParam(const std::string &paramString) {
...
void CalculateMinRestAfterCumulativeFTForEvaFdRuleParam::ParseParam(const DBRule& dbRule) {
...
bool CalculateMinRestAfterCumulativeFTForEvaFdRuleParam::MatchCrewQualification(std::shared_ptr<CREW> crew, const time_t& checkedStartTime, const time_t& checkedEndTime) const {
...
bool CalculateMinRestAfterCumulativeFTForEvaFdRuleParam::MatchComposition(const Duty& duty) const {
...
bool CalculateMinRestAfterCumulativeFTForEvaFdRuleParam::MatchDutyAssignments(const Duty& duty) const {
...
bool CalculateMinRestAfterCumulativeFTForEvaFdRuleParam::MatchDutyTypes(const Duty& duty) const {
    if (_dutyTypes.empty()) {
        return true;
    }
...
bool CalculateMinRestAfterCumulativeFTForEvaFdRuleParam::MatchRule(const Duty& duty) const {
