...
#ifndef _CHECKSCHMINRESTFOREVAFDRULEPARAM_H_
#define _CHECKSCHMINRESTFOREVAFDRULEPARAM_H_
...
class CheckSchMinRestForEvaFdRule;

class CheckSchMinRestForEvaFdRuleParam : public RuleParam {
friend class CheckSchMinRestForEvaFdRule;
private:
    explicit CheckSchMinRestForEvaFdRuleParam(const Rule* rule):RuleParam(rule) {};
...
#endif //_CHECKSCHMINRESTFOREVAFDRULEPARAM_H_
