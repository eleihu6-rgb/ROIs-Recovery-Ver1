...
#ifndef _MINWOCLATLAYOVERSTATIONFOREVAFDRULEPARAM_H_
#define _MINWOCLATLAYOVERSTATIONFOREVAFDRULEPARAM_H_
...
class CheckMinWOCLAtLayoverStationForEvaFdRule;
class CumulativeFtLimitSlideListener;

class MinWOCLAtLayoverStationForEvaFdRuleParam : public RuleParam {
	friend class CheckMinWOCLAtLayoverStationForEvaFdRule;
private:
    explicit MinWOCLAtLayoverStationForEvaFdRuleParam(const Rule* rule) :RuleParam(rule) {};
...
#endif //_MINWOCLATLAYOVERSTATIONFOREVAFDRULEPARAM_H_
