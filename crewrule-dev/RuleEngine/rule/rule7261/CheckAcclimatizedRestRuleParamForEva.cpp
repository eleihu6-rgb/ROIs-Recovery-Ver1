...
void CheckAcclimatizedRestRuleParamForEva::ParseParam(const DBRule& dbRule) {
...
bool CheckAcclimatizedRestRuleParamForEva::MatchCrewQualification(std::shared_ptr<CREW> crew, const time_t& checkedStartTime, const time_t& checkedEndTime) const {
...
bool CheckAcclimatizedRestRuleParamForEva::MatchParam(const ROSTER& roster) const {
	return true;
}

//检查是否满足参数
int CheckAcclimatizedRestRuleParamForEva::CheckParam(const ROSTER& roster) const {
