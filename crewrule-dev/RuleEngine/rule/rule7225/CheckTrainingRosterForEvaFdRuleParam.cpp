...
void CheckTrainingRosterForEvaFdRuleParam::ParseParam(const std::string &paramString) {
...
void CheckTrainingRosterForEvaFdRuleParam::ParseParam(const DBRule& dbRule) {
...
bool CheckTrainingRosterForEvaFdRuleParam::MatchCrewQualification(std::shared_ptr<CREW> crew, const time_t& checkedStartTime, const time_t& checkedEndTime) const {
...
bool CheckTrainingRosterForEvaFdRuleParam::MatchParam(const ROSTER& roster) const {
	return true;
}

//检查是否满足参数
int CheckTrainingRosterForEvaFdRuleParam::CheckParam(const ROSTER& roster) const {
