...
void CheckSchConsecutiveWOCLRestForEvaRuleParam::ParseParam(const DBRule& dbRule) {
...
bool CheckSchConsecutiveWOCLRestForEvaRuleParam::MatchCrewQualification(std::shared_ptr<CREW> crew, const time_t& checkedStartTime, const time_t& checkedEndTime) const {
