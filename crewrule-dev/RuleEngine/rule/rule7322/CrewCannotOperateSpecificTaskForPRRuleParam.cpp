...
void CrewCannotOperateSpecificTaskForPRRuleParam::ParseParam(const std::string &paramString) {
...
void CrewCannotOperateSpecificTaskForPRRuleParam::ParseParam(const DBRule& dbRule) {
...
//bool CrewCannotOperateSpecificTaskForPRRuleParam::MatchCrewQualification(std::shared_ptr<CREW> crew, const time_t& checkedStartTime, const time_t& checkedEndTime) const {
...
bool CrewCannotOperateSpecificTaskForPRRuleParam::MatchPairingAttributes(const ROSTER* roster) const {
...
bool CrewCannotOperateSpecificTaskForPRRuleParam::MatchFlightAirportCategories(const Segment* segment) const {
...
bool CrewCannotOperateSpecificTaskForPRRuleParam::MatchFlightRoutes(const Segment* segment) const {
...
bool CrewCannotOperateSpecificTaskForPRRuleParam::MatchActingRankAndIsTraining(const ROSTER* roster, const Segment* segment) const {
...
bool CrewCannotOperateSpecificTaskForPRRuleParam::MatchTrainingRoles(const ROSTER* roster, const Segment* segment) const {
...
bool CrewCannotOperateSpecificTaskForPRRuleParam::MatchCrewNationalities(const std::shared_ptr<CREW>& crew) const {
...
bool CrewCannotOperateSpecificTaskForPRRuleParam::MatchFlight(const ROSTER* roster, const Segment* segment) const {
	auto& dbData = this->GetRule()->GetDataContext();
...
bool CrewCannotOperateSpecificTaskForPRRuleParam::MatchGroundRoster(const ROSTER* roster) const {
	auto& dbData = this->GetRule()->GetDataContext();
...
bool CrewCannotOperateSpecificTaskForPRRuleParam::MatchCrew(const ROSTER* roster, const std::shared_ptr<CREW>& crew) const {
...
string CrewCannotOperateSpecificTaskForPRRuleParam::GetCrewFilterConditionDesc() const {
	stringstream ss;
...
string CrewCannotOperateSpecificTaskForPRRuleParam::GetTaskFilterConditionDesc() const {
	stringstream ss;
