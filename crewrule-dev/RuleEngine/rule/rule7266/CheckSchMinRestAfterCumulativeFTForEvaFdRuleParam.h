...
#ifndef _CHECKSCHMINRESTAFTERCUMULATIVEFTFOREVAFDRULEPARAM_H_
#define _CHECKSCHMINRESTAFTERCUMULATIVEFTFOREVAFDRULEPARAM_H_
...
class CheckSchMinRestAfterCumulativeFTForEvaFdRule;

class CheckSchMinRestAfterCumulativeFTForEvaFdRuleParam : public RuleParam {
friend class CheckSchMinRestAfterCumulativeFTForEvaFdRule;
private:
    explicit CheckSchMinRestAfterCumulativeFTForEvaFdRuleParam(const Rule* rule):RuleParam(rule) {};
...
#endif //_CHECKSCHMINRESTAFTERCUMULATIVEFTFOREVAFDRULEPARAM_H_
