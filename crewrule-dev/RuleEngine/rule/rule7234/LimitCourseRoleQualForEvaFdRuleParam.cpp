...
void LimitCourseRoleQualForEvaFdRuleParam::ParseParam(const std::string &paramString) {
...
void LimitCourseRoleQualForEvaFdRuleParam::ParseParam(const DBRule& dbRule) {
...
bool LimitCourseRoleQualForEvaFdRuleParam::MatchCrewQualification(std::shared_ptr<CREW> crew, const time_t& checkedStartTime, const time_t& checkedEndTime) const {
...
bool LimitCourseRoleQualForEvaFdRuleParam::MatchParam(const ROSTER& roster) const {
	return true;
}