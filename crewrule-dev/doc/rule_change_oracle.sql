-- 备份表
CREATE TABLE rule_20240702_01 as select * from rule;
select * from rule_20240702_01;

CREATE TABLE rule_parameter_20240702_01 as select * from rule_parameter;
...
-- 2024/12/19 法规3024 ROSCRW-9138 【EVAFD】【RULE】3023/3024 法规新增pairing base参数
...
-- value部分
update rule_parameter set param_values=(SUBSTRING_INDEX2(param_values, ',', 3) || ',*,' || SUBSTRING_INDEX2(param_values, ',', -3))
...
-- value部分
update rule_parameter set param_values=(SUBSTRING_INDEX2(param_values, ',', 5) || ',*,' || SUBSTRING_INDEX2(param_values, ',', -5) || ',Y,TW')
...
-- value部分
update rule_parameter set param_values=('*,*,*,*,' || param_values)
...
update rule_parameter set param_values=(param_values || ',9999:00') 
...
update rule_parameter set param_values=(SUBSTRING_INDEX2(param_values, ',', 2) || ',*,' || SUBSTRING_INDEX2(param_values, ',', -2))
...
update rule_parameter set param_values=(SUBSTRING_INDEX2(param_values, ',', 4) || ',*,*,' || SUBSTRING_INDEX2(SUBSTRING_INDEX2(param_values, ',', -4), ',', 2) ||  ',*,' || SUBSTRING_INDEX2(param_values, ',', -5))
where rule_id in (select id from rule where function=6100) and param_names like 'table%Row%';
...
update rule_parameter set param_values=('*,2025-01-01,2025-12-31,' || param_values) 
...
-- 6100 更新 rule_parameter的table row
update rule_parameter set param_values=(SUBSTRING_INDEX(param_values, ',', 4) || ',*,' || SUBSTRING_INDEX(param_values, ',', -4))
where rule_id in (select id from rule where function=6100) and param_names like 'table%Row%';
...
update rule_parameter set param_values=(SUBSTRING_INDEX2(param_values, ',', 6) || ',*,' || SUBSTRING_INDEX2(param_values, ',', -6))
...
-- 7219 table1 header，新增参数Min Working Hour
-- table1 header部分
...
-- table1 value部分
update rule_parameter set param_values=(SUBSTRING_INDEX2(param_values, ',', 11) || ',*,' || SUBSTRING_INDEX2(param_values, ',', -11))
where rule_id in (select id from rule where function=7219) and param_names like 'table1Row%';

-- 2025/04/16 法规7212 ROSCRW-12008 【EVAFD】【RULE】7212/7214逻辑调整
-- 7212法规新增参数：sleep cycle start, sleep cycle end, 修改法规参数min wocl number -> min sleep cycle
-- header部分
...
-- value部分
update rule_parameter set param_values=SUBSTRING_INDEX2(param_values, ',', 9) || ',22:00,06:00,' || SUBSTRING_INDEX2(PARAM_VALUES, ',' , -9)
...
-- value部分
update rule_parameter set param_values=SUBSTRING_INDEX2(param_values, ',', 8) || ',22:00,06:00,' || SUBSTRING_INDEX2(PARAM_VALUES, ',' , -8)
...
-- 8008法规新增参数：airports
-- header部分
update rule_parameter set param_values='Crew Nationality,Departure Country,Destination Country,Flight Numbers,Airports,Travel Doc Types,Validity Unit,Number,Only Check Layover,Check On Type(S/D/P)'
where rule_id in (select id from rule where function=8008) and param_names like 'table%Header%' 
	and param_values='Crew Nationality,Departure Country,Destination Country,Flight Numbers,Travel Doc Types,Validity Unit,Number,Only Check Layover,Check On Type(S/D/P)';
	
-- value部分
update rule_parameter set param_values=SUBSTRING_INDEX2(param_values, ',', 4) || ',*,' || SUBSTRING_INDEX2(PARAM_VALUES, ',' , -4)
where rule_id in (select id from rule where function=8008) and param_names like 'table%Row%';


-- 2025/04/27 法规8048 ROSCRW-9459 【EVAFD】【RULE】每天最多一个duty start或一个duty end
-- 8048法规新增参数：Check By Brief
-- header部分
update rule_parameter set param_values='Bases,Ranks,Fleets,Teams,Assignments:Only One Roster In One Day,Exception1(Non-Overlap)(Directional),Exception2(Overlap)(Directional),Check By Brief'
where rule_id in (select id from rule where function=8048) and param_names like 'table%Header%' 
	and param_values='Bases,Ranks,Fleets,Teams,Assignments:Only One Roster In One Day,Exception1(Non-Overlap)(Directional),Exception2(Overlap)(Directional)';
	
-- value部分
update rule_parameter set param_values=(param_values || ',N') 
where rule_id in (select id from rule where function=8048) and param_names like 'table%Row%';

-- 2025/05/19 法规3021 ROSCRW-12311 [TG][法规][OMA]Positioning duty check-in时间需要单独设定
-- 3021法规新增参数：duty assignments
-- header部分
update rule_parameter set param_values='Airport,DepStart,DepEnd,Duty Type,Airlines,Flt Nums,Fleets,Assignment,Duty Assignments,Is Training,Brief Time'
where rule_id in (select id from rule where function=3021) and param_names like 'table%Header%' 
	and param_values='Airport,DepStart,DepEnd,Duty Type,Airlines,Flt Nums,Fleets,Assignment,Is Training,Brief Time';
	
-- value部分
update rule_parameter set param_values=SUBSTRING_INDEX2(param_values, ',', 7) || ',*,' || SUBSTRING_INDEX2(PARAM_VALUES, ',' , -7)
where rule_id in (select id from rule where function=3021) and param_names like 'table%Row%';
...
-- value部分
update rule_parameter set param_values=SUBSTRING_INDEX2(param_values, ',', 8) || ',*,' || SUBSTRING_INDEX2(PARAM_VALUES, ',' , -8)
...
-- value部分
update rule_parameter set param_values=PARAM_VALUES  || ',DUTY'
...
-- value部分
update rule_parameter set param_values=(PARAM_VALUES || ',CD,*')
...
-- header部分
update rule_parameter set param_values='Airport,Inbound Duty,Outbound Duty,Aircraft Change,FLT2FERRY,FERRY2FLT,DHD2FLT,FLT2DHD,TRAIN2FLT,FLT2TRAIN,Fleets,Sub Fleets,Mct,Max Conn'
where rule_id in (select id from rule where function=3001) and param_names like 'table%Header%' 
	and param_values='Airport,Inbound Duty,Outbound Duty,Aircraft Change,FLT2FERRY,FERRY2FLT,DHD2FLT,FLT2DHD,TRAIN2FLT,FLT2TRAIN,Mct';
	
-- value部分
update rule_parameter set param_values=SUBSTRING_INDEX2(PARAM_VALUES, ',', 10) || '*,*,' || SUBSTRING_INDEX2(PARAM_VALUES, ',', -10) || ',*'
...
-- header部分 table header
-- 7251 更新 rule_parameter的table header，新增参数：PNR Exception Code
...
-- value部分 table row
update rule_parameter set param_values=(SUBSTRING_INDEX2(param_values, ',', 9) || ',00:00,999:00,*,' || SUBSTRING_INDEX2(param_values, ',', -9))
...
-- value部分 table row
update rule_parameter set param_values=(SUBSTRING_INDEX2(param_values, ',', 2) || ',1,' || SUBSTRING_INDEX2(param_values, ',', -2))
...
-- value部分 table row
update rule_parameter set param_values=(SUBSTRING_INDEX2(param_values, ',', 7) || ',1,' || SUBSTRING_INDEX2(param_values, ',', -7))
...
-- value部分 table row
update rule_parameter set param_values=(param_values || ',F')
...
-- value部分 table row
update rule_parameter set param_values=(param_values || ',D')
...
-- header部分 table header
update rule_parameter set param_values='Bases,Ranks,Fleets,Crew Teams,DO Assignment Group,Min DO,Period,Unit,Utilize Post Duty Rest,Count Blank Day,Count Layover,Layover Timemode,Month Numbers,Ref Date,Is Rolling'
...
-- value部分 table row
update rule_parameter set param_values=(param_values || ',*,Y')
...
-- value部分
update rule_parameter set param_values=(param_values || ',00:30')
...
-- header部分
update rule_parameter set param_values='Airport,DepStart,DepEnd,Duty Type,Airlines,Flt Nums,Fleets,Assignment,Is Training,Courses,Brief Time'
where rule_id in (select id from rule where function=3021) and param_names like 'table%Header%' 
	and param_values='Airport,DepStart,DepEnd,Duty Type,Airlines,Flt Nums,Fleets,Assignment,Is Training,Brief Time';

update rule_parameter set param_values='Airport,Duty Type,Airlines,Flt Nums,Fleets,Assignment,Is Training,Courses,Debrief Time'
where rule_id in (select id from rule where function=3022) and param_names like 'table%Header%' 
	and param_values='Airport,Duty Type,Airlines,Flt Nums,Fleets,Assignment,Is Training,Debrief Time';

-- value部分
update rule_parameter set param_values=SUBSTRING_INDEX2(param_values, ',', 9) || ',*,' || SUBSTRING_INDEX2(PARAM_VALUES, ',' , -9)
where rule_id in (select id from rule where function=3021) and param_names like 'table%Row%';
...
-- 8030法规，新增参数Assignment Group,Assignment (未验证)
-- header部分
...
-- value部分
update rule_parameter set param_values=(SUBSTRING_INDEX2(param_values, ',', 1) || ',*,*,' || SUBSTRING_INDEX2(param_values, ',', -1))
...
-- 8030法规，新增参数DIR,Acting Ranks (未验证)
-- header部分
...
-- 7306法规，新增参数Attributes,is Turnaround(Y/N) (SQL未验证)
-- header部分
...
-- value部分
update rule_parameter set param_values=(SUBSTRING_INDEX2(param_values, ',', 5) || ',*,*,' || SUBSTRING_INDEX2(param_values, ',', -5))
...
-- value部分
update rule_parameter set param_values=(param_values || ',SBY')
...
-- value部分
update rule_parameter set param_values=(SUBSTRING_INDEX2(param_values, ',', 3) || ',*,' , SUBSTRING_INDEX2(param_values, ',', -3) || ',02:00')
...
-- value部分
update rule_parameter set param_values=(param_value || ',*,*')
...
-- header部分
update rule_parameter set param_values='Flight Fleets,Flight Assignment Groups,Flight Compositions,Crew Teams,Crew Nationality,Destination Countries,Acting Ranks,Required Qualifications,Attributes,Dep,Arr,Min Limits,Max Limits'
where rule_id in (select id from rule where function=8072) and param_names like 'table%Header%' 
...
-- value部分
update rule_parameter set param_values=(SUBSTRING_INDEX2(param_values, ',', 4) || ',FLY,' || SUBSTRING_INDEX2(param_values, ',', -4))
where rule_id in (select id from rule where function=7311) and param_names like 'table%Row%';
...
update rule_parameter set param_values=('*,'|| SUBSTRING_INDEX(param_values, ',', 5) || ',*,'|| SUBSTRING_INDEX(param_values, ',', -5))
where rule_id in (select id from rule where function=8030) and param_names like 'table%Row%';
...
update rule_parameter set param_values=(SUBSTRING_INDEX2(param_values, ',', 6) || ',*,' || (SUBSTRING_INDEX2(SUBSTRING_INDEX2(param_values, ',', -6), ',', 1) || ',*,' || SUBSTRING_INDEX2(SUBSTRING_INDEX2(param_values, ',', -6), ',', -1)))
...
update rule_parameter set param_values=CONCAT(SUBSTRING_INDEX(param_values, ',', 5) , ',*,*,R,' , SUBSTRING_INDEX(param_values, ',', -5))
...
update rule_parameter set param_values=(param_values || ',*,00:00')
...
-- 6025 更新 rule_parameter的table row
update rule_parameter set param_values=(SUBSTRING_INDEX2(param_values, ',', 1) || ',*,' || (SUBSTRING_INDEX2(SUBSTRING_INDEX2(param_values, ',', -1), ',', 2) || ',*,' || SUBSTRING_INDEX2(SUBSTRING_INDEX2(param_values, ',', -1), ',', -1)))
where rule_id in (select id from rule where function=6025) and param_names like 'table%Row%';
...
update rule_parameter set param_values=(SUBSTRING_INDEX2(param_values, ',', 10) || ',*,' || SUBSTRING_INDEX2(param_values, ',', -9))
where rule_id in (select id from rule where function=8002) and param_names like 'table%Row%';
...
where rule_id in (select id from rule where function=2003) and param_names like 'table%Row%'
	and (length(param_values) - length(replace(param_values, ',', ''))) < 8;
...
-- 2026/04/13 法规7484 HXCREW-XXX 【HKA】【Rule7484】Max FDP for HX - 新增参数Single Fly Sector Blh Range和Rest Facility
-- 7484法规table2新增参数：Single Fly Sector Blh Range,Rest Facility
-- header部分 table2Header
update rule_parameter set param_values='COMPOSITIONS,DUTY ASSIGNMENTS,PRECEDING REST RANGE,LANDING LOWER,LANDING UPPER,MAX FDP,SINGLE FLY SECTOR BLH RANGE,REST FACILITY'
where rule_id in (select id from rule where function=7484) and param_names like 'table2Header%'
	and param_values='COMPOSITIONS,DUTY ASSIGNMENTS,PRECEDING REST RANGE,LANDING LOWER,LANDING UPPER,MAX FDP';

-- value部分 table2Row
update rule_parameter set param_values=(param_values || ',*,*')
where rule_id in (select id from rule where function=7484) and param_names like 'table2Row%';

-- 2026/04/13 法规7491 HXCREW-XXX 【HKA】【Rule7491】FDP Extension for CC for HX - 新增参数Extended To FDP
...
update rule_parameter
set param_values='*,*,' || SUBSTRING_INDEX2(param_values, ',', -6) || ',1,CW'
...
-- value部分
update rule_parameter 
set param_values=(SUBSTRING_INDEX2(param_values, ',', 3)||',*,'||SUBSTRING_INDEX2(param_values, ',', -3))
...
update rule_parameter
set param_values=(SUBSTRING_INDEX2(param_values, ',', 16)||',*,'||SUBSTRING_INDEX2(param_values, ',', -2))
where rule_id in (select id from rule where function=3021) and param_names like 'table%Row%';
...
-- 7480 更新 rule_parameter的table row，在Excluding First Recovery 6 offset DO(Y/N)后添加*作为Following Start of DDO(Y/N)的默认值
update rule_parameter
...
update rule_parameter
set param_values=('Compositions,' || SUBSTR(param_values, LENGTH('Composition,') + 1))
...
-- header部分
update rule_parameter
set param_values=(param_values || ',Qual Fleets,Qual Fleet Groups,Crew Fleets')
...
where rule_id in (select id from rule where function=7203) and param_names like 'table%Header%'
	and param_values in (
		'Bases,Compositions,Duty Type,Consecutive Duty,Segment Assignments,Flight Fleets,Report Time Ranges,DP Encroaching Period,Encroaching Duration,Override Duty Attributes,Sector BLH Ranges,Max Sector',
		'Bases,Compositions,Duty Type,Consecutive Duty,Segment Assignments,Flight Fleets,Report Time Ranges,DP Encroaching Period,Encroaching Duration,Override Duty Attributes,Sector BLH Ranges,Max Sector,Consecutive Duty'
	);
