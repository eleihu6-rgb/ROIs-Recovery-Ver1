...
-- Slip station anchor tokens (Table 1 "Slip station"):
--   - "*"  : same city as arrival airport into slip (coterminals treated as one city)
--   - "%"  : same airport as arrival airport into slip (exact airport only)
