...
VALUES
  (200003610, 7422001, 1,
   'table2Header',
   'Sby Reduces Rest and LN,Do starts after,Standby Assignments,Operating definition,Service type,Fleets,Pairing length ends at',
   'ROIS', CURRENT_TIMESTAMP);
...
VALUES
  (200003611, 7422001, 1,
   'table2Row1',
   'Y,TRANSPORT,SBY,DUTY_IS_OPERATING,*,*,DEBRIEF',
   'ROIS', CURRENT_TIMESTAMP);
