...
VALUES
  (200003437, 7466001, 1,
   'table1Header',
   'Slip Station,Slip Arr Is Operating,Slip Dep Is Operating,Slip Local Night Range,COP Start DOW,Flight Numbers,Period Start Date,Period End Date,Extra Days Off',
