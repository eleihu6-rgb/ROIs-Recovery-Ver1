...
--     COP Start DOW, Flight Numbers, Period Start Date, Period End Date, Extra Days Off
...
SET param_names = 'table1Header',
    param_values = 'Slip Station,Slip Arr Is Operating,Slip Dep Is Operating,Slip Local Night Range,COP Start DOW,Flight Numbers,Period Start Date,Period End Date,Extra Days Off'
WHERE rule_id = 7466001
