...
-- mysql
CREATE TABLE `rule_parameter_20260531_2311` LIKE `rule_parameter`;
INSERT INTO `rule_parameter_20260531_2311` SELECT * FROM `rule_parameter`;
...
select rule_id, param_values,
	CONCAT(SUBSTRING_INDEX(param_values, ',', 2), ',*,', SUBSTRING_INDEX(param_values, ',', -1)) as new_param_values
from rule_parameter
