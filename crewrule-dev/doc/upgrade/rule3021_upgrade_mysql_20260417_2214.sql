...
-- mysql
CREATE TABLE `rule_parameter_20260417_1453` LIKE `rule_parameter`;
INSERT INTO `rule_parameter_20260417_1453` SELECT * FROM `rule_parameter`;
...
select rule_id, param_values,
	CONCAT(SUBSTRING_INDEX(param_values, ',', 10),',*,',SUBSTRING_INDEX(param_values, ',', -3)) as new_param_values, 
	SUBSTRING_INDEX(param_values, ',', 10) as head, 
