...
-- oracle
CREATE TABLE rule_parameter_20260421_2241 as select * from rule_parameter;
...
select rule_id, param_values,
	(SUBSTRING_INDEX2(param_values, ',', 3)||',*,'||SUBSTRING_INDEX2(param_values, ',', -3)) as new_param_values, 
