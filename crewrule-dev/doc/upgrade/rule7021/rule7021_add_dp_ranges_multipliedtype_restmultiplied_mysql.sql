...
-- mysql
CREATE TABLE `rule_parameter_20260522_0934` LIKE `rule_parameter`;
INSERT INTO `rule_parameter_20260522_0934` SELECT * FROM `rule_parameter`;
...
select rule_id, param_values,
	CONCAT(SUBSTRING_INDEX(param_values, ',', 6),',*,*,*,' , SUBSTRING_INDEX(param_values, ',', -1)) as new_param_values
from rule_parameter
