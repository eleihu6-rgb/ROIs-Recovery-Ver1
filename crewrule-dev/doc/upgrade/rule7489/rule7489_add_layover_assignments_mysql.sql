...
-- mysql
CREATE TABLE `rule_parameter_20260526_0944` LIKE `rule_parameter`;
INSERT INTO `rule_parameter_20260526_0944` SELECT * FROM `rule_parameter`;
...
SELECT rule_id, param_values,
	CONCAT(SUBSTRING_INDEX(param_values, ',', 5), ',*,*,', SUBSTRING_INDEX(param_values, ',', -2)) AS new_param_values,
