...
-- mysql
CREATE TABLE `rule_parameter_20260522_1500` LIKE `rule_parameter`;
INSERT INTO `rule_parameter_20260522_1500` SELECT * FROM `rule_parameter`;
...
select rule_id, param_values,
	CONCAT(SUBSTRING_INDEX(param_values, ',', 8), ',*,', SUBSTRING_INDEX(param_values, ',', -5)) as new_param_values
from rule_parameter
