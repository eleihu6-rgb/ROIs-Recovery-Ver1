...
-- mysql
CREATE TABLE `rule_parameter_20260518_1304` LIKE `rule_parameter`;
INSERT INTO `rule_parameter_20260518_1304` SELECT * FROM `rule_parameter`;
...
select rule_id, param_values,
	CONCAT(SUBSTRING_INDEX(param_values, ',', 4),',*,',SUBSTRING_INDEX(param_values, ',', -5)) as new_param_values, 
	SUBSTRING_INDEX(param_values, ',', 4) as head, 
	SUBSTRING_INDEX(param_values, ',', -5) as tail 
from rule_parameter 
