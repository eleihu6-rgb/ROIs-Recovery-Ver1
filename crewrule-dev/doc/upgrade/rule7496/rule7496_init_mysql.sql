...
INSERT INTO rule_parameter(id, rule_id, phase_id, param_names, param_values, modified_by, last_modified) VALUES (208300315, 7496001, 1, 'tableHeader', 'Consecutive Assignment Group A,Consecutive Assignment A,Consecutive Assignment Group B,Consecutive Assignment B,Directional,Min Working Days,Working Assignment Group,Working Assignments,Count Blank Day', 'ROIS', CURRENT_TIMESTAMP);
