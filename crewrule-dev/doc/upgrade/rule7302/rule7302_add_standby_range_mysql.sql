...
-- mysql
CREATE TABLE `rule_parameter_20260601_1404` LIKE `rule_parameter`;
INSERT INTO `rule_parameter_20260601_1404` SELECT * FROM `rule_parameter`;
...
select rule_id, param_values,
	CONCAT(SUBSTRING_INDEX(param_values, ',', 6), ',*,*,*,', SUBSTRING_INDEX(param_values, ',', -2)) as new_param_values
from rule_parameter
