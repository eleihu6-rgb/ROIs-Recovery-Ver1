...
export const RESERVE_LINE_RULE_DATE_SCOPE_MODES = new Set([
  "whole_month",
  "first_half",
  "second_half",
  "date_range",
...
export const LINE_RULE_METADATA = [
  [301, "RESERVE_SHORT_CALL_TYPE", "Reserve Preference", "Reserve", "Reserve line-level call type rule for reserve short-call preferences. Parameters_JSON is {\"action\":\"award|avoid\",\"callType\":\"PRAM\",\"dateScope\":{\"mode\":\"whole_month|first_half|second_half|date_range\"}}."],
  [202, "MAX_CONSECUTIVE_DAYS_ON", "Max Consecutive Days On", "DaysOff", "DaysOff rule-level constraint. Parameters_JSON is {\"minDaysOn\":number,\"maxDaysOn\":number,\"minDaysOff\":0,\"maxDaysOff\":0}."],
  [203, "MIN_CONSECUTIVE_DAYS_OFF", "Min Consecutive Days Off", "DaysOff", "DaysOff rule-level constraint. Parameters_JSON is {\"minDaysOn\":1,\"maxDaysOn\":bid month days,\"minDaysOff\":number,\"maxDaysOff\":number}."],
  [204, "MIN_CONSECUTIVE_DAYS_OFF_IN_WINDOW", "Long Stretch Off / Compressed Flying", "DaysOff", "DaysOff rule-level constraint. Parameters_JSON is {\"from\":\"YYYY-MM-DD\",\"minimumDaysOff\":number,\"to\":\"YYYY-MM-DD\"}."],
  ...
  [407, "MIN_BASE_LAYOVER", "Minimum Base Layover", "Legacy", "Minimum home-base spacing rule. Parameters_JSON is {\"value\":\"HHH:MM\"}."],
  [408, "COMMUTER_PATTERN", "Commuter Pattern", "Legacy", "Pattern rule. Parameters_JSON has minDaysOff, minDaysOn, maxDaysOn, and optional dateRange."],
