...
export interface PairingImportRecord {
  ...
  source: string         // pairing source from F8/NOC
...
// Both table families share the same job structure; tableType drives routing in the worker.
export interface MandayImportJob extends ImportJobMeta {
  tableType: 'fd' | 'cc_am'
  records: MandayFdRecord[] | MandayCcAmRecord[]
}

/** Daily record for crew_manday_fd_* tables (flight-deck pilots, division='P'). */
export interface MandayFdRecord {
  crewId: string
  crewBaseDt: string           // 'YYYY-MM-DD'
  ft?: number
  augumentFt?: number
  doubleFt?: number
  blh?: number
  ...
  expBlh?: number
  quarantine?: number
  custData1?: number | null
  custData2?: number | null
  highPlateau?: number
  operatingFleets?: string | null
  operatingAirports?: string | null
  takeoff?: number
  landing?: number
  isPosition?: number
  workingHour?: number | null
  pncCredit?: number | null
  simCredit?: number | null
  alCredit?: number | null
  olCredit?: number | null
  freighterCredit?: number | null
  layoverDay?: number | null
  lhPerDiem?: number | null
  sbyDp?: number
  dhdDp?: number
  fleetTakeoff?: string | null
  fleetLanding?: string | null
  nightTakeoff?: string | null
  nightLanding?: string | null
  schCredit?: number | null
  schPerDiem?: number | null
  schLhPerDiem?: number | null
  schPncCredit?: number | null
  schSimCredit?: number | null
  schAlCredit?: number | null
  schOlCredit?: number | null
  schFreighterCredit?: number | null
  attributes?: string | null
  intBlh?: number | null
  fltNum?: number | null
  crossTzDutyCount?: number | null
  layoverTimes?: number | null
  layoverDuration?: number | null
}

/** Daily record for crew_manday_cc_am_* tables (cabin crew, division='C'). */
